        ...
        with connect(
            ...
            with connection.cursor() as cursor:
                ...
                for student_id in ids_list:
                    cursor.execute("SELECT skill FROM skills WHERE skill_id IN (SELECT skill_id FROM students_skills WHERE user_id = " + str(student_id) + ")")
                ...
                cursor.execute("SELECT skill FROM skills WHERE skill_id IN (SELECT skill_id FROM position_skills WHERE position_id = " + str(position_id) + ")")
